...
import com.example.godspower.gtucvote.qr.Intents;
import com.example.godspower.gtucvote.qr.ViewfinderView;
...
public class QRScannerActivity extends Activity implements
	...
	public void onResume() {
		...
		if (intent != null) {
			...
			if (Intents.Scan.ACTION.equals(action)) {
				decodeFormats = intent.getParcelableExtra(String.valueOf(intent));
	...
	public void getViewfinderView(int aVoid) {
